...
// class made as Ticket, make it public abstract
public abstract class Ticket {
    //provide various attributes like seatNo, price , time ,pnr etc..
...
//use this keyword to the current object in a method
    ...
    // getters and setters using intellij or can be written manually
